        ...
        try:
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                payload = {
                    "model": self.model,
                    "messages": [
                        {"role": "system", "content": "Ти професійний асистент з аналізу продуктивності. Генеруй звіти українською мовою, описуючи КОНКРЕТНІ ЗАВДАННЯ та їх результати, а не просто загальний час по проектах. Використовуй вказаний формат, надавай змістовну і конкретну інформацію."},
